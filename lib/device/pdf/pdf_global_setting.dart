...
class PDFSetting {
  ...
  static final headerFontData = File('fonts/carlito/Carlito-Bold.ttf').readAsBytesSync().buffer.asByteData();
  static final bodyFontData = File('fonts/carlito/Carlito-Regular.ttf').readAsBytesSync().buffer.asByteData();
}