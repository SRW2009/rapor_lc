...
final npbList = mapelList
    ...
    .map<NPB>((e) => NPB(npbNo++, e, '${_rand.nextInt(100)}%'))
    .toList();
...
final _nkVariables = [...mapelList, ...mapelList_observation]
    .where((e) => e.divisi?.name == 'Kesantrian')
    .toList();
final nkList = List<NK>.generate(_nkVariables.length, (i) => NK(i, _nkVariables[i].name,
    _rand.nextInt(100), _rand.nextInt(100), _rand.nextInt(100), _rand.nextInt(100), 'B'));

final nilai_s_odd = Nilai(0, BulanAndSemester(1,1), '2020/2021', santriList.first,
    npb: npbList_observation, nk: nkList, nhb: nhbList_observation);
final nilai_s_even = Nilai(1, BulanAndSemester(7,2), '2020/2021', santriList.first,
    npb: npbList, nk: nkList, nhb: nhbList);

final nilai_s_even2 = Nilai(2, BulanAndSemester(9,2), '2020/2021', santriList.first,
    npb: npbList, nk: nkList, nhb: nhbList);

final nilai_s_even3 = Nilai(3, BulanAndSemester(12,2), '2020/2021', santriList.first,
    npb: npbList, nk: nkList, nhb: nhbList);