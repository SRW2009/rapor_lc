...
class ManageNilaiPage extends View {
  ...
  ManageNilaiPage(this.santri, {Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => ManageNilaiPageView(santri);
}

class ManageNilaiPageView extends ViewState<ManageNilaiPage, ManageNilaiController> {
  ManageNilaiPageView(santri)
      : super(ManageNilaiController(NilaiRepositoryImpl(), santri));
    ...
    return Card(
      ...
      child: Column(
        children: [
          Container(
            height: 6,
            color: (item.isObservation) ? Colors.grey : Colors.blue,
          ),
          Padding(
